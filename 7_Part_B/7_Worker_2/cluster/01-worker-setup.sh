...
###############################################################################
# [WORKER-2] Kubernetes Worker Node Setup Script
# Machine: Worker-2 (Service B + Service C run here)
# Run: sudo bash 01-worker-setup.sh
###############################################################################
set -euo pipefail

echo "============================================="
echo "  WORKER-2: Kubernetes Node Setup"
echo "============================================="

# Set hostname
echo "[STEP 1] Setting hostname to worker-2..."
sudo hostnamectl set-hostname worker-2
echo "  ✓ Hostname set to worker-2"
