...
# ----------------------------------------------------
# test_flannel.sh - Redeploy the cluster with Flannel
# ----------------------------------------------------

echo "======================================"
echo "    Redeploying Cluster: FLANNEL      "
echo "======================================"
...
echo "-> Deploying distributed application with Active CNI set to Flannel..."
...
echo "======================================"
echo "    FLANNEL Deployment Complete!      "
